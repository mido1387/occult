...
def create_inp_file(template, coords, basename, nsolv, charge, spin):
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: python nsolv.py <nsolv> <xyz_file> <charge> <spin>")
        sys.exit(1)
    ...
    create_inp_file(template, coords, basename, nsolv, charge, spin)
